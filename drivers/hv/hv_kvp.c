...
static int process_ob_ipinfo(void *in_msg, void *out_msg, int op)
{
	...
	case KVP_OP_GET_IP_INFO:
		 ...
		 */
		len = utf8s_to_utf16s_new((char *)in->body.kvp_ip_val.ip_addr,
		...
		len = utf8s_to_utf16s_new((char *)in->body.kvp_ip_val.sub_net,
		...
		len = utf8s_to_utf16s_new((char *)in->body.kvp_ip_val.gate_way,
		...
		len = utf8s_to_utf16s_new((char *)in->body.kvp_ip_val.dns_addr,
		...
		len = utf8s_to_utf16s_new((char *)in->body.kvp_ip_val.adapter_id,
