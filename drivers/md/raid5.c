...
static void free_scratch_buffer(raid5_conf_t *conf, struct raid5_percpu *percpu)
{
...
static int alloc_scratch_buffer(raid5_conf_t *conf, struct raid5_percpu *percpu)
{
